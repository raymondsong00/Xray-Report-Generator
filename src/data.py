...
def generate_data():
    ...
    h5_base = "data/"
    jpg_dest_folder = "data/jpg"
    deid_keys_fp = "data/deid-keys.csv"
    ...
    fake_id_fp = "data/falseids-accn.csv"
    train_fp = 'data/train_accn.csv'
    test_fp = 'data/test_accn.csv'
    ...
    generate_train_json(img_ids, set(train_accn), t2020, a2020, img_fp, './data/generic_prompt_train.json', generic_question)
    generate_test_jsonl(img_ids, set(test_accn), t2020, a2020, img_fp, './data/generic_prompt_test.jsonl', generic_question)

    generate_train_json(img_ids, set(train_accn), t2020, a2020, img_fp, './data/context_prompt_train.json', context_question)
    generate_test_jsonl(img_ids, set(test_accn), t2020, a2020, img_fp, './data/context_prompt_test.jsonl', context_question)

    # Generate Test set answers
    ...
    pd.concat([a2020.loc[intersection_a2020], t2020.loc[intersection_t2020]]).to_csv('./data/test_set_radiologist_reports.csv')
